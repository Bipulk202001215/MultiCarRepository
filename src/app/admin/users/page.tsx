...
import { UserData, CreateUserData, UserRole } from '@/lib/types';
import { USER_ROLES, ROLE_DISPLAY_NAMES } from '@/lib/roles';
...
export default function UsersManagementPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      // In production, use Cloud Functions to delete from Auth
          ...
          {deletingUser && (
            <div className="mb-8 rounded-lg bg-white dark:bg-zinc-900 p-6 shadow">
              ...
              <p className="mb-4 text-sm text-yellow-600 dark:text-yellow-400">
                Note: The user account in Firebase Auth will remain. To fully
                delete the user, use Firebase Admin SDK or Cloud Functions.
              </p>
              <div className="flex gap-4">
                <button
